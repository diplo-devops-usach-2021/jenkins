    ...
    pipeline {
        ...
        post {
            always {
                ...
                slackSend channel: '#jenkins-ci', color: 'normal', message: 'Job Name: ' + env.JOB_NAME + ', BuildTool: ' +  params.buildTool + ', rama: ' + verifyBranchName() + '.', teamDomain: 'dipdevopsusac-tr94431', tokenCredentialId: 'slack-token'
            }
            success{
